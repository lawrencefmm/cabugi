...
- The local judge spike now proves core verdict handling, but it still needs follow-up coverage for production sandbox hardening beyond Docker-based local isolation.
