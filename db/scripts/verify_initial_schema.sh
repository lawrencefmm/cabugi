...
assert_equals "$(psql_exec "SELECT COUNT(*) FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'submissions' AND column_name = 'compile_output_excerpt'")" "1" "submissions must include compile output excerpts"
